#!/bin/bash
# ==============================================================================
# Skrip Deployment Otomatis: WA Bot Bisnis AI di VPS Linux (Ubuntu / Debian)
# Menjalankan bot CS & Penjualan 24/7 non-stop di background menggunakan PM2
# ==============================================================================

set -e

echo "======================================================"
echo "    DEPLOYMENT OTOMATIS: WA BOT BISNIS AI (VPS)       "
echo "======================================================"
...
# Pastikan edisi terkunci ke bisnis
mkdir -p config
echo '{"edition": "bisnis"}' > config/edition.json

# 6. Jalankan Server dengan PM2
echo -e "\n[6/6] Menjalankan WA Bot Bisnis AI di background..."
pm2 stop wa-bot-bisnis 2>/dev/null || true
pm2 delete wa-bot-bisnis 2>/dev/null || true
...
echo -e "\n======================================================"
echo "  🎉 WA BOT BISNIS AI BERHASIL DIJALANKAN DI CLOUD VPS!"
echo "======================================================"
...
echo "- Pantau Log: pm2 logs wa-bot-bisnis"
echo "- Restart:    pm2 restart wa-bot-bisnis"
echo "- Matikan:    pm2 stop wa-bot-bisnis"
echo "======================================================"
